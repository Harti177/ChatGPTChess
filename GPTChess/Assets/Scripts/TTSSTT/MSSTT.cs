...
#endif
using TMPro;
public class MSSTT : MonoBehaviour
{
    ...
    public async void ButtonClick()
    {
        ...
        {
            recoButton.GetComponent<Image>().color = Color.white;
        ...
        {
            recoButton.GetComponent<Image>().color = Color.green;
            if (!Microphone.IsRecording(Microphone.devices[0]))
            {
...
#endif
            config = SpeechConfig.FromSubscription("fb6f4d93a1024881bb535d1ebacf4626", "eastus");

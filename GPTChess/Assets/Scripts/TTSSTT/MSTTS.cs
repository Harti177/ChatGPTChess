...
public class MSTTS : MonoBehaviour
{
    ...
    private const string SubscriptionKey = "fb6f4d93a1024881bb535d1ebacf4626";
    ...
    {
        text = _text;
        StartCoroutine(DelayAndClick());
    }

    IEnumerator DelayAndClick()
    {
